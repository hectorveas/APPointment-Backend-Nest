...
export class PatientController {
    ...
    @Put()
    async updatePatient(@Res() res, @Body() createPatientDTO: CreatePatientDTO, @Query('id') id) {
        const patient = await this.patientService.updatePatient(id, createPatientDTO);
