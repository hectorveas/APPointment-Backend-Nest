...
export class AppointmentController {
    ...
    @Put()
    async updateAppointment(@Res() res, @Body() createAppointmentDTO: CreateAppointmentDTO, @Query('id') id) {
        const appointment = await this.appointmentService.updateAppointment(id, createAppointmentDTO);
